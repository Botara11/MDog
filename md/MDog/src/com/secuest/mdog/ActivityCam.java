...
public class ActivityCam extends Activity {
  ...
  private OnClickListener mSaveImageButtonClickListener = new OnClickListener() {
    ...
    public void onClick(View v) {
      ...
      if (saveFile != null) {
        ...
        Toast.makeText(ActivityCam.this, "Unable to open file for saving image.",
  ...
  private void startImageCapture() {
    ...
    //startActivityForResult(new Intent(ActivityCam.this, CameraActivity.class), TAKE_PICTURE_REQUEST_B);
  }
    ...
    if (mCameraBitmap != null) {
      ...
      try {
          ...
          if (!mCameraBitmap.compress(Bitmap.CompressFormat.PNG, 100, outStream)) {
            Toast.makeText(ActivityCam.this, "Unable to save image to file.",
            Toast.LENGTH_LONG).show();
          } else {
            Toast.makeText(ActivityCam.this, "Saved image to: " + file.getPath(),
            Toast.LENGTH_LONG).show();
          }
          outStream.close();
        } catch (Exception e) {
